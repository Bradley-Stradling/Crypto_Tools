...
echo -e "Example run ${red}encipher${reset} with a keyword of ACE\n\""\
		...
		"${reset}\b\""
echo -e "or \n\"${yellow}./Keyword_Rotation_Cipher.sh --encipher --keyword ACE"\
		"\b --input-File infile --output-File outfile${reset}\"\n"
echo -e "Example run ${red}decipher${reset} with a keyword of ACE\n\""\
		"${yellow}\b./Keyword_Rotation_Cipher.sh -d -k ACE -i infile -o outfile"\
		"${reset}\b\""
echo -e "or \n\"${yellow}./Keyword_Rotation_Cipher.sh --decipher --keyword ACE"\
		"\b --input-File infile --output-File outfile${reset}\"\n"
echo -e "Example run ${red}verbose${reset} with a keyword of ACE\n\"${yellow}"\
		"\b./Keyword_Rotation_Cipher.sh -e -k ACE -i infile -o outfile -v"\
		"${reset}\b\""
echo -e "or \n\"${yellow}./Keyword_Rotation_Cipher.sh --encipher --keyword ACE"\
		"--input-File infile --output-File outfile --verbose${reset}\"\n"
echo -e "Example run ${red}very verbose${reset} with a keyword of ACE\n\""\
		"${yellow}\b./Keyword_Rotation_Cipher.sh -e -k ACE -i infile -o outfile -vv"\
		"${reset}\b\""
